...
import Code39Reader from '@zxing/library/core/oned/Code39Reader';
...
class Code39ExtendedBlackBox2Spec extends AbstractBlackBoxSpec {
    public constructor() {
        super('test/core/resources/blackbox/code39-2', new Code39Reader(false, true), BarcodeFormat.CODE_39);
