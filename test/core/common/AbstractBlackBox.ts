...
import BarcodeFormat from '@zxing/library/core/BarcodeFormat';
import BinaryBitmap from '@zxing/library/core/BinaryBitmap';
import DecodeHintType from '@zxing/library/core/DecodeHintType';
import LuminanceSource from '@zxing/library/core/LuminanceSource';
import Reader from '@zxing/library/core/Reader';
import Result from '@zxing/library/core/Result';
import ResultMetadataType from '@zxing/library/core/ResultMetadataType';
import TestResult from '../common/TestResult';
import HybridBinarizer from '@zxing/library/core/common/HybridBinarizer';
